...
\vspace*{-8px}
\footnotetext[1]{Landis, H. Production-Ready Global Illumination (2004).}
\end{frame}
...
Ambient occlusion approximates some aspects of Global Illumination (GI).
...
\begin{figure}
    \centering
    \includegraphics[width=1.0\linewidth]{images/gi_room.jpg}
\end{figure}
%\end{frame}
\framebreak
%\begin{frame}
...
Furthermore, current real-time graphics hardware is mostly based on rasterization $ \Rightarrow $ ideal for direct illumination.
...
% crytek-crysis 2007
% nasce come tecnica per approssimare ao vera in rendering engine real time con rasterization
